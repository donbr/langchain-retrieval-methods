...
# If using hybrid or sparse retrieval, also import FastEmbedSparse
# from langchain_qdrant import FastEmbedSparse

# Set up the embedding model (must match what was used for ingestion)
embeddings = OpenAIEmbeddings(model="text-embedding-3-small")
...
# Connect to existing Qdrant collections for retrieval only
baseline_vectorstore = QdrantVectorStore.from_existing_collection(
...
parent_children_vectorstore = QdrantVectorStore.from_existing_collection(
    embedding=embeddings,
...
semantic_vectorstore = QdrantVectorStore.from_existing_collection(
    embedding=embeddings,
